 ...
 */
export function requireClientManagement() {
...
/**
 * Require equipment management permissions
 */
export function requireEquipmentManagement() {
  return requirePermission(PermissionAction.MANAGE, PermissionResource.EQUIPMENT);
}
